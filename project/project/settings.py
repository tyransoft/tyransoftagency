...
ALLOWED_HOSTS = ['tyransoftagency-production.up.railway.app','https://tyransoftagency-production.up.railway.app']
CSRF_TRUSTED_ORIGINS=['https://tyransoftagency-production.up.railway.app']
